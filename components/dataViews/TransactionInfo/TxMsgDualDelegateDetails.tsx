...
interface TxMsgDualDelegateDetailsProps {
  readonly msgValue: MsgDualDelegate;
}

const TxMsgDualDelegateDetails = ({ msgValue }: TxMsgDualDelegateDetailsProps) => {
  const { chain } = useChains();

  return (
    <>
      <li>
        <h3>Dualstaking MsgDelegate</h3>
      </li>
      <li>
        <label>Amount:</label>
...
export default TxMsgDualDelegateDetails;
